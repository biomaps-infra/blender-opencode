...
For how to create node trees, add modifiers, link node sockets, and manage node groups in Python, see `blender-core_api/references/geometry-nodes.md`. MolecularNodes custom nodes appear in the Shift+A menu under the "Molecular Nodes" submenu.
