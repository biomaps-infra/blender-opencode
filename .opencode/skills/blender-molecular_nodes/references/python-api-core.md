...
## Cross-References to blender-core_api

| Task on MN objects | See blender-core_api reference |
|-------------------|--------------------------|
| Custom shader materials for MN objects | `blender-core_api/references/materials-and-nodes.md` — assign via `mol.object.data.materials.append(mat)` |
| Geometry Nodes concepts (creating/linking node trees) | `blender-core_api/references/geometry-nodes.md` |
| Modifiers on MN objects | `blender-core_api/references/modifiers-and-constraints.md` |
| Animation keyframes on MN objects | `blender-core_api/references/handlers-and-timers.md` for frame handlers |
| Stale references after undo/redo | `blender-core_api/references/gotchas-and-pitfalls.md` — re-fetch `mol.object` after undo |
| Render operators (headless render) | `blender-core_api/references/operators-reference.md` — `render.render(write_still=True)` |
| Math/transforms/BVHTree | `blender-core_api/references/math-and-spatial.md` |
| Headless mode pitfalls | `blender-core_api/references/gotchas-and-pitfalls.md` — "Headless / Background Mode" section |
